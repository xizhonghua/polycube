...
//    if(jtf::Endianness::is_little_endian()) {
//        jtf::Endianness::swap_endian(&(node_temp[0]),node_num * 3);
//    }
...
//    if(jtf::Endianness::is_little_endian()) {
//        jtf::Endianness::swap_endian(&(temp[0]),5 * tet_num);
//    }
...
//    if(jtf::Endianness::is_little_endian()) {
//        jtf::Endianness::swap_endian(&(TYPE_ARRAY[0]),tet_num);
//    }
//    os.write((char*)&(TYPE_ARRAY[0]), tet_num * sizeof(INT));
//}

//template <typename OS, typename Iterator, typename INT>
//void vtk_data_b(OS &os, Iterator first, INT size, const char *value_name,
//                const char *table_name = "my_table")
//{
